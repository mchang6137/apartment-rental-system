...
function nodeServer(count, nodeRepo) {
	...
	//1 Per Machine - Requires 20 Machines
	...
	this.kib1.placeOn({diskSize: diskSizes[1]});
	this.kib2.placeOn({diskSize: diskSizes[1]});
	this.kib3.placeOn({diskSize: diskSizes[1]});
	this.kib4.placeOn({diskSize: diskSizes[1]});

	this.app[1].placeOn({diskSize: diskSizes[2]});
	this.kib5.placeOn({diskSize: diskSizes[2]});
	this.spark.placeOn([diskSizes[2], diskSizes[2], diskSizes[2], diskSizes[2], diskSizes[0], diskSizes[3]]);
	...
	//this.kib.placeOn({diskSize: diskSizes[2]});
	//this.kib1.placeOn({diskSize: diskSizes[2]});
	//this.kib2.placeOn({diskSize: diskSizes[2]});
	//this.kib3.placeOn({diskSize: diskSizes[2]});
	//this.kib4.placeOn({diskSize: diskSizes[2]});
	//this.kib5.placeOn({diskSize: diskSizes[2]});
	
	//this.postgres.placeOn({diskSize: diskSizes[3]});
	//this.spark.placeOn([diskSizes[3], diskSizes[3], diskSizes[3], diskSizes[3], diskSizes[3], diskSizes[3]]);
    };
